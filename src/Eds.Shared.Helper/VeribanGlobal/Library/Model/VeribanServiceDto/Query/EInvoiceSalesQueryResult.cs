...
{
    [DataContract]
    public class EInvoiceSalesQueryResult : DocumentQueryResult
    {
        [DataMember]
        ...
        [DataMember]
        public string GtbReferenceNumber { get; set; }
        [DataMember]
        public string GtbGcbTescilNo { get; set; }
        [DataMember]
        public string GtbFiiliIhracatTarihi { get; set; }
    }
}
