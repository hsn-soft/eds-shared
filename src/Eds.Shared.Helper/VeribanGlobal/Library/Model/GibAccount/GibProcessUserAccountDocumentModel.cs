...
namespace Eds.Shared.Helper.VeribanGlobal.Library.Model.GibAccount
{
    ...
    public class GibProcessUserAccountDocument
    {
        public GibProcessUserAccountDocument()
        {
        ...
        private ProcessUserAccountDataArea _dataArea;
        [XmlElement("DataArea")]
        public virtual ProcessUserAccountDataArea DataArea
        {
            get { return this._dataArea; }
            set { if (value != null) this._dataArea = value; else this._dataArea = new ProcessUserAccountDataArea(); }
        }
    }
}