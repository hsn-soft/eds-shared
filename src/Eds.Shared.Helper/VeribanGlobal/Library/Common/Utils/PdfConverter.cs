...
namespace Eds.Shared.Helper.VeribanGlobal.Library.Common.Utils
{
    ...
    public class PdfConvertException : Exception
    {
        ...
        protected PdfConvertException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
    ...
    public class PdfConvertTimeoutException : PdfConvertException
    {
        ...
        protected PdfConvertTimeoutException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            ...
            get
            {
                if (_e == null)
                    _e = new PdfConvertEnvironment
                    {
                        ...
                        WkHtmlToPdfPath = @"C:\VeribanLibrary\wkhtmltopdf\bin\wkhtmltopdf.exe",
                        Timeout = 60000
                    };
                return _e;
            }
