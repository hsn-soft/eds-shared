namespace Eds.Shared.Helper.VeribanGlobal.Library.Common.Utils
{
    public static class EnumUtils
    {
        ...
        {
            return ParseEnum<T>(inString, default(T), ignoreCase, throwException);
        }
        ...
        {
            return ParseEnum<T>(input, default(T), throwException);
        }
        ...
        {
            return ParseEnum<T>(inString, defaultValue, ignoreCase, throwException);
        }
        #endregion
        ...
        {
            return ParseEnum<T>(input, defaultValue, throwException);
        }
        #endregion
    }
