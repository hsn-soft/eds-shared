...
namespace Eds.Shared.Helper.eInvoice.Library.Model
{
    ...
    public class InvoiceModel
    {
        ...
        public string schemaLocation { get; set; } = "urn:oasis:names:specification:ubl:schema:xsd:Invoice-2 UBL" + (UblTr2HandlerEInvoice.UblVersion == "2.0" ? "TR" : "") + "-Invoice-" + UblTr2HandlerEInvoice.UblVersion + ".xsd";
        ...
        // Bu elemanda UBL-TR içerisinde yer alan fatura tiplerine ait kodlar yazılacaktır. "SATIS" veya "IADE" olmalıdır.
        ...
        //Bu elemana tevkifatlı faturalarda yer alan tevkifat ile ilgili bilgiler yazılacaktır.
